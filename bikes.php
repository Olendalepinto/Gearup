<html>
	...
	<body>
		...
		<input type="hidden" id="bikeModel" name="bikeModel" value="">
			<tr>
				<td class="vname">
				...
				<td>
				<input type="submit" value="BOOK NOW" onclick="setBikeModel(this)">
				</td>
			</tr>
			<tr>	
				<td class="vname">
        ...
        var bikeModelElement = parentTr.querySelector('td h2');
        // Extract the car model from the text content
        var bikeModel = bikeModelElement.textContent.trim();
        // Set the value of the hidden input field to the car model
        document.getElementById('bikeModel').value = bikeModel;
				}
		</script>
		<footer>
