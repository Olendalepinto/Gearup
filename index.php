<html>
	...
	<body>
		<div class="up" id="up">
			<div class="logo"><img src="images/gearupbgno.png" height="100%" width="9.7%" style="float:left;margin:-1.2% 0 0 6.5%;">
				...
				<ul>
					...
					<li><div class="dropdown">
                        ...
                        <div class="dropdown-content" onmouseover="Glow3()" onmouseout="Initial3()">
                            ...
                            <a href="corporate.php">BIKE RENTAL SERVICE</a>
                        </div>
                    </div></li>
		...
		<div style="text-align:center;padding:1% 0 5% 0"><img src="images/gearupbgno.png" style="height:auto;" height="25%" width="25%"></div>
		<div>
		...
		<h1 style="font-size:2vw;color:#292929;margin:-1.3% 0 0 71%">&gt;</h1>
			...
			<br><br>
		<img class="image" src="images/Mysore Palace Images.jpg">
			...
			<table  style="width:82%;margin:auto;">
				<tr>
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">GEAR UP EXOTIC CARS offers to make it easy for clients to get the right car at
							 the right price at the right time. If you are looking for car rental service in Mysuru/India or minibusses hire 
							 services, then our company is the right option for you. Get the best deal on booking of luxury car and coaches in Mysuru.</h3>
						<a href="rental.php"  style="text-decoration:none;"><h3 class="readmore">READ MORE</h3></a>
					</td>
					<td>
						<img src="images/busi.png" style="float:left;"><h1 style="font-size:1.4vw;color:black;">BIKE RENTAL SERVICE</h1>
        ...
        <footer>
			<table style="height:10%;">
				...
				<tr bgcolor="#252525">
					<td class="widget">
						<p class="text">GEAR UP EXOTIC RENTALS is one of the reputed Travel<br>
						Company in India.At GEARUP EXOTIC CARS<br>
