	...
	<body>
				...
				<nav>
					<ul>
						...
						<li><div class="dropdown">
								<a id="glow3" class="navi" href="index.php#service">Service</a>
                    ...
                    <a class="login-btn" href="admin.php">Admin Login</a></li>
					</ul>
				</nav>
			</div>
			<script>
		...
		<input type="hidden" id="carModel" name="carModel" value="">
			<tr>
				...
				<td>
				<input type="submit" value="BOOK NOW" onclick="setCarModel(this)">
				</td>
			</tr>
			<tr>	
				<td>
		...
		<script>
				...
				function setCarModel(button) {
        // Traverse up to the parent <tr> element
        var parentTr = button.closest('tr');
        // Find the <h2> element inside the <td> element with the car model
        var carModelElement = parentTr.querySelector('td h2');
        // Extract the car model from the text content
        var carModel = carModelElement.textContent.trim();
        // Set the value of the hidden input field to the car model
		...
		<footer>
			...
			<table>
				...
				<tr bgcolor="#252525">
					<td class="widget">
						<p class="text">GEARUP EXOTIC CARS is one of the reputed Travel<br>
				...
				<tr bgcolor="black">
					<td class="copyright" colspan="2"><font style="text-align:center;">Copyright 2024 All Right Reserved<font></td>
				</tr>
			</table>
		</footer>
